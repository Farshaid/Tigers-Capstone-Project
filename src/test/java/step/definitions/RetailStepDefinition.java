...
public class RetailStepDefinition extends Base{
					...
					//-=-=-=-=-==-=-=- INSTANTIATING OUR OBJECTS CLASS -=-=-=-=-==-=-=- \\
	...
	public void user_is_on_retail_website() {
		...
		logger.info("Since we can see this Text: " + actualText + " It Confirms that indeed We are in TekSchool Retail Website");
	}
	...
	public void user_click_on_link(String link) {
		retailPageObj.registerAnAffiliateAccountLink(link);
